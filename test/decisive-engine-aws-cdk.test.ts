        ...
        it('should have an OTELOperator Helm chart', () => {
            template.hasResourceProperties('Custom::AWSCDK-EKS-HelmChart',
                Match.objectLike({
                    ...
                    Version: '0.43.1',
                    Wait: true,
                    Values: '{"admissionWebhooks":{"certManager":{"enabled":true}},"manager":{"image":{"repository":"public.ecr.aws/p3k6k6h3/opentelemetry-operator","tag":"latest"}}}',
                })
            )
        })
