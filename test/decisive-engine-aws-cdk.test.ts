...
describe('DecisiveEngine', () => {
    ...
    describe('Nodegroups', () => {
        it('should have a Bottlerocket Nodegroup', () => {
        ...
        it('should have an MDAI Console Helm chart', () => {
            template.hasResourceProperties('Custom::AWSCDK-EKS-HelmChart',
                Match.objectLike({
                    ...
                    Wait: true,
                    Values: '{"ingress":{"userPoolArn":"","userPoolClientId":"","userPoolDomain":"","acmArn":"","enabled":false}}',
                })
            )
        })
    })
    describe('Kubernetes resources', () => {
        it('should have resources', () => {
            ...
            template.resourceCountIs('Custom::AWSCDK-EKS-HelmChart', 6)
